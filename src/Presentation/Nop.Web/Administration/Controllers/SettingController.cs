...
namespace Nop.Admin.Controllers
{
    public partial class SettingController : BaseAdminController
	{
        ...
        public ActionResult GeneralCommon()
        {
            ...
            model.SeoSettings.CustomHeadTegs = seoSettings.CustomHeadTegs;
            //override settings
            if (storeScope > 0)
            {
                ...
                model.SeoSettings.CustomHeadTegs_OverrideForStore = _settingService.SettingExists(seoSettings, x => x.CustomHeadTegs, storeScope);
            }
        ...
        public ActionResult GeneralCommon(GeneralCommonSettingsModel model)
        {
            ...
            seoSettings.CustomHeadTegs = model.SeoSettings.CustomHeadTegs;
            ...
            _settingService.SaveSettingOverridablePerStore(seoSettings, x => x.CustomHeadTegs, model.SeoSettings.CustomHeadTegs_OverrideForStore, storeScope, false);
